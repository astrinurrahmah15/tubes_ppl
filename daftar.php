...
<head>
    ...
    <script>
        function validateRegistrationForm(event) {
            ...
            if (!status) {
                showError('Status harus dipilih.');
...
<div class="bg">
    <div class="overlay">
        <div class="register-container">
            <h1>GaweYuk</h1>
            <form id="registerForm" action="register.php" method="POST" onsubmit="return validateRegistrationForm(event)">
    ...
    <div class="input-group mb-3">
        ...
        <span class="input-group-text" onclick="togglePasswordVisibility('password', 'toggle-password')">
            <i class="fas fa-eye" id="toggle-password"></i>
        </span>
    </div>
    <div class="input-group mb-3">
        <span class="input-group-text"><i class="fas fa-lock"></i></span>
        <input type="password" id="confirm-password" name="confirm_password" class="form-control" placeholder="Konfirmasi kata sandi">
        <span class="input-group-text" onclick="togglePasswordVisibility('confirm-password', 'toggle-confirm-password')">
    ...
    <input type="text" id="skills" name="skills" class="form-control" placeholder="Masukkan keahlian (pisahkan dengan koma)">
</div>
